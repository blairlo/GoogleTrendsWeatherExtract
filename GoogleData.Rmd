...
Group1 <- get_daily_gtrend(c('weather','puppies'),from,to,low_search_volume = TRUE, geo = c(baseline,
                                                                          "US-OR-813",
                                                                          "US-AR-670",
                                                                          "US-OH-515"))
...
Group2 <- gtrends(search, time = time, low_search_volume = TRUE, geo = c(baseline, "US-OR-813",
                                                                                  "US-AR-670"))
...
DMA_list2<-lapply(DMA.list,get_daily_gtrend, keyword=keyword, from=from, to=to)#
