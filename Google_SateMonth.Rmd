...
AcrossState_Weather.gov<-TrendsAcrossGeo(search= "weather.gov",
                                     time="2005-01-01 2017-12-31",
                                     type = "web",
                                      baseline = "US-SD")
...
test<-subset(AcrossState_Weather.gov, AcrossState_Weather.gov$hits==100)
print(test)
...
```{r}
Trends_AcrossState<-left_join(AcrossState_Weather, AcrossState_Forecast[,c("geo","date", "hits")], by = c("geo","date"))%>%
      left_join(AcrossState_Temperature[,c("geo","date", "hits")], by = c("geo","date"))%>%
      left_join(AcrossState_Weather.gov[,c("geo","date", "hits")], by = c("geo","date"))%>%
